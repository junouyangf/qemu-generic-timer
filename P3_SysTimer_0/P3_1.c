...
int main (void)
{
	...
	// Inicializamos el contador de interrupción a 0 y definimos el intervalo de interrupción.
	irq_counter=0;
	ra=irq_counter;
	interval=0x00080000;
	...
	// Bit 1 del registro de control del System Timer indica si los valores coinciden
	// En este caso hacemos un clear.
	PUT32(CS,2);
